...
const ChatRightbar = () => {
    ...
    return (
        ...
        <Box flex={2} padding={2} borderRadius={5} maxHeight={'75vh'} minHeight={'75vh'} sx={{ overflowY: "scroll", boxShadow: "rgba(0, 0, 0, 0.35) 0px 10px 15px" }}>
            <TextField fullWidth size='small' name='find' variant='standard' value={find} placeholder='find' onChange={handleChange} />
